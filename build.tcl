...
#
# build.tcl: Tcl script for re-creating project 'zynq_seq_cnn'
#
# Generated by Vivado on Mon Apr 04 18:08:50 +0200 2022
...
#
#    "C:/Users/Michael/Desktop/zynq_seq_cnn.xpr/zynq_seq_cnn/zynq_seq_cnn.srcs/sources_1/bd/design_1/design_1.bd"
#    "C:/Users/Michael/Desktop/zynq_seq_cnn.xpr/zynq_seq_cnn/zynq_seq_cnn.srcs/C:/Users/Michael/Desktop/zynq_seq_cnn.xpr/zynq_seq_cnn/zynq_seq_cnn.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd"
#    "C:/Users/Michael/Desktop/zynq_seq_cnn.xpr/zynq_seq_cnn/zynq_seq_cnn.srcs/sources_1/imports/zynq7_eth_dma/archive_project_summary.txt"
#    "C:/Users/Michael/Desktop/zynq_seq_cnn.xpr/zynq_seq_cnn/archive_project_summary.txt"
#    "C:/Users/Michael/Desktop/zynq_seq_cnn.xpr/zynq_seq_cnn/zynq_seq_cnn.srcs/constrs_1/imports/Arty_Z7/Arty-Z7-20-Master.xdc"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
# "[file normalize "$origin_dir/../zynq_seq_cnn.xpr/zynq_seq_cnn/zynq_seq_cnn.srcs/sources_1/bd/design_1/design_1.bd"]"\
# "[file normalize "$origin_dir/../zynq_seq_cnn.xpr/zynq_seq_cnn/zynq_seq_cnn.srcs/./C:/Users/Michael/Desktop/zynq_seq_cnn.xpr/zynq_seq_cnn/zynq_seq_cnn.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd"]"\
# "[file normalize "$origin_dir/../zynq_seq_cnn.xpr/zynq_seq_cnn/zynq_seq_cnn.srcs/sources_1/imports/zynq7_eth_dma/archive_project_summary.txt"]"\
# "[file normalize "$origin_dir/../zynq_seq_cnn.xpr/zynq_seq_cnn/archive_project_summary.txt"]"\
 "[file normalize "$origin_dir/src/constrs/Arty-Z7-20-Master.xdc"]"\
  ]
  foreach ifile $files {
 ...
 # set paths [list \
 #"[file normalize "$origin_dir/../../AppData/Roaming/Xilinx/Vivado/zynq_seq_cnn.xpr/zynq_seq_cnn/zynq_seq_cnn.ipdefs/packaged"]"]"\
 # ]
 # foreach ipath $paths {
...
set _xil_proj_name_ "OPEN-HW-CNN-ZYNQ-WRAP"
...
# set orig_proj_dir "[file normalize "$origin_dir/../zynq_seq_cnn.xpr/zynq_seq_cnn"]"
...
# Create project
create_project OPEN-HW-CNN-ZYNQ-WRAP $origin_dir/OPEN-HW-CNN-ZYNQ-WRAP -part xc7z020clg400-1
...
# set files [list \
# [file normalize "${origin_dir}/../zynq_seq_cnn.xpr/zynq_seq_cnn/zynq_seq_cnn.srcs/sources_1/bd/design_1/design_1.bd"]\
# [file normalize "${origin_dir}/../zynq_seq_cnn.xpr/zynq_seq_cnn/zynq_seq_cnn.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd"]\
# [file normalize "${origin_dir}/../zynq_seq_cnn.xpr/zynq_seq_cnn/zynq_seq_cnn.srcs/sources_1/imports/zynq7_eth_dma/archive_project_summary.txt"]\
# [file normalize "${origin_dir}/../zynq_seq_cnn.xpr/zynq_seq_cnn/archive_project_summary.txt" ]\
# ]
...
#set file "zynq7_eth_dma/archive_project_summary.txt"
#set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
#set_property -name "is_enabled" -value "1" -objects $file_obj
#set_property -name "is_global_include" -value "0" -objects $file_obj
#set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
#set file "zynq_seq_cnn/archive_project_summary.txt"
#set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
#set_property -name "is_enabled" -value "1" -objects $file_obj
#set_property -name "is_global_include" -value "0" -objects $file_obj
#set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
set file "[file normalize ${origin_dir}/src/constrs/Arty-Z7-20-Master.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "Arty-Z7-20-Master.xdc"
...
# set_property -name "target_constrs_file" -value "$proj_dir/${_xil_proj_name_}.srcs/constrs_1/imports/Arty_Z7/Arty-Z7-20-Master.xdc" -objects $obj
# set_property -name "target_ucf" -value "$proj_dir/${_xil_proj_name_}.srcs/constrs_1/imports/Arty_Z7/Arty-Z7-20-Master.xdc" -objects $obj
...
# set_property -name "auto_incremental_checkpoint.directory" -value "C:/Users/michael/Documents/2020_10_cnn_hardware_demo/src/vivado_src/zynq7_eth_dma/zynq7_eth_dma.srcs/utils_1/imports/synth_1" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z020clg400-1 -flow {Vivado Implementation 2020} -strategy "Performance_ExtraTimingOpt" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
# set_property -name "auto_incremental_checkpoint.directory" -value "C:/Users/michael/Documents/2020_10_cnn_hardware_demo/src/vivado_src/zynq7_eth_dma/zynq7_eth_dma.srcs/utils_1/imports/impl_1" -objects $obj
...
if {[string equal [get_runs -quiet impl_1_copy_1] ""]} {
    create_run -name impl_1_copy_1 -part xc7z020clg400-1 -flow {Vivado Implementation 2020} -strategy "Performance_ExtraTimingOpt" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
  set_property strategy "Performance_ExtraTimingOpt" [get_runs impl_1_copy_1]
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
# set_property -name "auto_incremental_checkpoint.directory" -value "C:/Users/michael/Documents/2020_10_cnn_hardware_demo/src/vivado_src/zynq7_eth_dma/zynq7_eth_dma.srcs/utils_1/imports/impl_1_copy_1" -objects $obj
set_property -name "strategy" -value "Performance_ExtraTimingOpt" -objects $obj
set_property -name "steps.init_design.tcl.pre" -value "" -objects $obj
set_property -name "steps.init_design.tcl.post" -value "" -objects $obj
set_property -name "steps.init_design.args.more options" -value "" -objects $obj
