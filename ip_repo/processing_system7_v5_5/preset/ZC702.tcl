...
proc getPresetInfo  {} {
	return [dict create  name ZC702  display_name  {ZC702}   description  {ZC702 board preset}  vlnv  xilinx.com:ip:processing_system7:5.5]
}
...
proc apply_preset {IPINST} {
	...
	if { $c_board != "zc702" } {
	  send_msg_id PS7-6 WARNING "The applied preset does not match with $c_board board preset. You may not get expected settings for $c_board board. The ZC702 preset is designed for ZC702 board." -verbose
	}
 
 [namespace parent]::Check_for_unbonded_pins $IPINST "ZC702"
 return [dict create \
