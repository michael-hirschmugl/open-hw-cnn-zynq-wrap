...
proc getPresetInfo  {} {
	return [dict create  name ZC706  display_name  {ZC706}   description  {ZC706 board preset}  vlnv  xilinx.com:ip:processing_system7:5.5]
}
...
proc apply_preset { IPINST } {
	...
	if { $c_board != "zc706" } {
	  send_msg_id PS7-6 WARNING "The applied preset does not match with $c_board board preset. You may not get expected settings for $c_board board. The ZC706 preset is designed for ZC706 board." -verbose
	}
 [namespace parent]::Check_for_unbonded_pins $IPINST "ZC706"
 return [dict create \
