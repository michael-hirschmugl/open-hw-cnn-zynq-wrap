proc getPresetInfo  {} {
	return [dict create  name ZedBoard  display_name  {ZedBoard}   description  {Zedboard board preset}  vlnv  xilinx.com:ip:processing_system7:5.5]
}
...
proc apply_preset {IPINST} {
 ...
 [namespace parent]::Check_for_unbonded_pins $IPINST "ZedBoard"
 return [dict create \
